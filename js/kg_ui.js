    ...
    var Class = {
        ...
        /* 레이아웃 세팅 */, initLayoutOnce: function initLayoutOnce() {
            $(document).on('setLayout', function () {
                ...
                if (!Class.isWide) {
                    $snb.css({ height: $snbH, minHeight: $wrapH - $headerH });
...
$.fn.jsSelectCtrl = function () {
    var $wrapper = $(this);
    var $mBoardli = $('.mBoardWrap > ul li');
    var $reservationli = $('.reservationList li');
	var $peopleView = $('.peopleView li');

    $wrapper.find('.mBoardWrap li').click(function () {
        $($mBoardli).removeClass('on');
        $(this).addClass('on');
    })

    $wrapper.find('.reservationList li').click(function () {
        $($reservationli).removeClass('on');
        $(this).addClass('on');
    })

	$wrapper.find('.peopleView li').click(function () {
		$($peopleView).removeClass('on');
		$(this).addClass('on');
	})
